      ...
      if(Object.keys(time).length < 1 || (new Date().getTime() - time.weatherTime) > 600000) {
        navigator.geolocation.getCurrentPosition(position => {
          ...
          const success = (data) => {
            ...
            } else if(['Mist', 'Smoke', 'Haze', 'Sand, Dust Whirls', 'Fog',
          'Sand', 'Dust', 'Volcanic Ash', 'Squalls', 'Tornado'].includes(data.weather[0].main)){
              this.state.weather = night ? "AtmosphereNight" : "AtmosphereDay";
            } else {
